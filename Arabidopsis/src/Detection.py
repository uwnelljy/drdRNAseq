...
class EventDetection:
    ...
    def changepoint_position(self):
        la2 = self._lambda2
        beta_data = EventDetection.fusedlasso(self._shorter_genes_ratio, la2)
        cp_position_index = EventDetection.search_cp(beta_data)
        return beta_data, cp_position_index
